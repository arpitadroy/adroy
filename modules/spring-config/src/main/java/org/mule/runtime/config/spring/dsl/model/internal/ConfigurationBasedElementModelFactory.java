  ...
  private void handleInfrastructure(final ParameterModel paramModel, final DslElementSyntax paramDsl,
    ...
    switch (paramModel.getName()) {
      ...
      case STREAMING_STRATEGY_PARAMETER_NAME:
        ...
        ComponentIdentifier repeatableMemoryStream = newIdentifier(REPEATABLE_IN_MEMORY_BYTES_STREAM_ALIAS, paramDsl.getNamespace());
        ComponentIdentifier repeatableFileStream = newIdentifier(REPEATABLE_FILE_STORE_BYTES_STREAM_ALIAS, paramDsl.getNamespace());
