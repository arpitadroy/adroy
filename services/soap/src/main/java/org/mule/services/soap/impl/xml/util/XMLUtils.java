...
public class XMLUtils extends org.mule.runtime.core.util.XMLUtils {
   ...
   * <p>
   * Reproduces the behavior from {@link org.mule.services.soap.impl.xml.util.XMLUtils#toDocument(Object, MuleContext)} which works
  ...
  public static javax.xml.stream.XMLStreamReader toXMLStreamReader(javax.xml.stream.XMLInputFactory factory, Event event,
    ...
    } else if (obj instanceof org.mule.services.soap.impl.xml.stax.StaxSource) {
      return ((org.mule.services.soap.impl.xml.stax.StaxSource) obj).getXMLStreamReader();
  ...
  public static javax.xml.transform.Source toStreamSource(javax.xml.stream.XMLInputFactory xmlInputFactory, boolean useStaxSource,
      ...
      throws XMLStreamException {
    if (useStaxSource) {
      return new org.mule.services.soap.impl.xml.stax.StaxSource(xmlInputFactory.createXMLStreamReader(stream));
    } else {
