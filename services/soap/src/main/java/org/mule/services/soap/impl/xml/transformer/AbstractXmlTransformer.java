 ...
 * LICENSE.txt file.
 */
package org.mule.services.soap.impl.xml.transformer;
...
public abstract class AbstractXmlTransformer extends AbstractMessageTransformer implements Initialisable {
  ...
  public AbstractXmlTransformer() {
    ...
    registerSourceType(DataType.fromType(org.mule.services.soap.impl.xml.transformer.DelayedResult.class));
